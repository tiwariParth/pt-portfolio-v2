        ...
        >
          ...
          <h2 className="mb-6 sm:mb-8 text-xl sm:text-2xl md:text-3xl font-bold">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-0">
              <span className="text-fsNeon-primary">Full Stack Developer</span>
              <span className="text-white mx-2 hidden sm:inline">&</span>
              <span className="text-devopsNeon-primary">DevOps Engineer</span>
            </div>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 px-4 sm:px-0">
            ...
            <motion.a
              href="#contact"
              className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3 text-sm sm:text-base font-medium rounded-lg border-2 border-fsNeon-primary text-fsNeon-primary hover:bg-fsNeon-primary/10 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              transition={{ type: "spring", stiffness: 400, damping: 10 }}
            >
